...
<?php else : ?>
	...
	<?php foreach ($this->items as $i => &$media) : ?>
				...
				<?php if (in_array($media->access, $this->user->authorisedLevels())) : ?>
					<a href="index.php?option=com_media&view=media&layout=modal&tmpl=component&id=<?php echo $media->id; ?>" class="modal" ><img src="<?php echo plgContentMedia::getThumb($media->url); ?>" width="<?php echo $this->params->get('thumb_width',100);?>" height="<?php echo $this->params->get('thumb_height',75); ?>" /></a>
				<?php endif; ?>
