<?php
/**
 * @version		$Id: edit.php 19205 2010-10-22 19:50:48Z 3dentech $
...
<form action="<?php echo JRoute::_('index.php?option=com_languages'); ?>" method="post" name="adminForm" id="language-form" class="form-validate">
